...
<head>
    ...
    <title> Product catalog1 - Aarshiya automobiles and spare parts</title>
...
<body>
    ...
    <div class="container">
        <div class="navbar">
            <div class="logo">
                <img src="images1/logo.png.jpg" width="125px">
...
<div class="small-container">
        <div class="row">
            <div class="col-4">
                <img src="images1/rtr1604v.jpg">
                <center>
                <h2 style="color:#d7385e;">catalog for Apache RTR 160 4v</h2>
                <p><b>click below to download PDF</b></p>
                <a href="Apache160.pdf.pdf" target="_">View PDF</a>
              </center>
            </div>
        </div>
</div>    
